...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - Brandon-Lea Price</title>
        <meta
          name="description"
          content="Things I’ve made to show what I can do."
        />
      </Head>
      <SimpleLayout
        title="Things I’ve made to show what I can do."
        intro="I've worked on a fair few things over the past years to show what I can do and to show I am willing to try something new."
      >
        <ul
          role="list"
